...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.Budgeting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("MrpCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);

                    b.Property<string>("MrpDescription")
                        .IsRequired()
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.BudgetingSubject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("BudgetingId");

                    b.HasIndex("ModifierUserId");

                    b.HasIndex("ProductId");

                    b.ToTable("BudgetingSubjects");
                });
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.PAttachment", b =>
                {
                    ...
                    b.Property<long?>("POPreparationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.POPreparation", b =>
                {
                    b.Property<long>("POPreparationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("HasQualityControl")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsQualityControlDone")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal>("SubmitProgress")
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.Role", b =>
                {
                    ...
                    b.Property<bool>("IsSendSmsNotification")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("SCMFormPermission")
                        .HasColumnType("int");

                    b.Property<int>("SCMModule")
                        .HasColumnType("int");

                    b.Property<int>("SCMWorkFlow")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.BudgetingSubject", b =>
                {
                    ...
                    b.HasOne("Raybod.SCM.Domain.Model.Budgeting", "Budgeting")
                        .WithMany("BudgetingSubjects")
                        .HasForeignKey("BudgetingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.PAttachment", b =>
                {
                    ...
                    b.HasOne("Raybod.SCM.Domain.Model.POPreparation", "POPreparation")
                        .WithMany("POPreparationAttachments")
                        .HasForeignKey("POPreparationId")
                        .OnDelete(DeleteBehavior.Restrict);
