...
namespace Raybod.SCM.DataAccess.Migrations
{
    ...
    partial class SqlServerSCMContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.Contract", b =>
                {
                    ...
                    b.Property<bool>("ConstructionManagement")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("DocumentManagement")
                        .HasColumnType("bit");

                    b.Property<bool>("FileDrive")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PurchaseManagement")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.FileDriveDirectory", b =>
                {
                    ...
                    b.ToTable("FileDriveDirectories");
                });

            modelBuilder.Entity("Raybod.SCM.Domain.Model.FileDriveFile", b =>
                {
                    ...
                    b.ToTable("fileDriveFiles");
                });

            modelBuilder.Entity("Raybod.SCM.Domain.Model.FileDriveShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.PlanService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.TeamWorkUserOperationGroup", b =>
                {
                    b.Property<int>("TeamWorkUserId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TeamWorkUserId", "OperationGroupId");

                    b.HasIndex("OperationGroupId");

                    b.ToTable("TeamWorkUserOperationGroups");
                });
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.FileDriveDirectory", b =>
                {
                    ...
                    b.HasOne("Raybod.SCM.Domain.Model.FileDriveDirectory", "ParentDirectory")
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.FileDriveFile", b =>
                {
                    ...
                    b.HasOne("Raybod.SCM.Domain.Model.FileDriveDirectory", "Directory")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.FileDriveShare", b =>
                {
                    ...
                    b.HasOne("Raybod.SCM.Domain.Model.FileDriveFile", "File")
                        .WithMany("Shares")
            ...
            modelBuilder.Entity("Raybod.SCM.Domain.Model.TeamWorkUserOperationGroup", b =>
                {
                    ...
                    b.HasOne("Raybod.SCM.Domain.Model.TeamWorkUser", "TeamWorkUser")
                        .WithMany("TeamWorkUserOperationGroups")
                        .HasForeignKey("TeamWorkUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
